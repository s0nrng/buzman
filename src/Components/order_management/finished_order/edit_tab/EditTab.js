...
function EditTab({selectedOrder, setSelectedOrder, customer, setCustomer, products, setProducts, setEditMode}){
    ...
    return (
        <div style={mainStyle}>
            ...
            <ButtonPanel selectedOrder={selectedOrder} setSelectedOrder={setSelectedOrder} products={products} setProducts={setProducts} setCustomer={setCustomer} setEditMode={setEditMode} customer={customer}/>
            <EditCart products={products}/>
        </div>
    )
}
